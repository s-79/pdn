...
<nav class="navbar navbar-expand-xl navbar fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><strong class="titre text-white">PROMENEURS DU NET 93</strong></a>&nbsp;
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarsExampleDefault">
            <ul class="navbar-nav nav-pills mb-2 mb-md-0">
                <li class="nav-item dropdown">
                    <a class="nav-link px-3" href="#" id="menuderoulantPres" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <li class="nav-item mx-1">
                    <a id="menu_pdn" class="nav-link px-3" href="pdn.php"><i class="fas fas fa-comments fa-lg pe-2"></i>PROMENEURS</a>
                </li>
                <li class="nav-item mx-1">

...
if($id) { $query = "CALL act_Update ('$id', '$dat', '$type', '$organise', '$intitule', '$uuid', '$lieu', '$ville', '$pj', '$support', '$facebook', '$whatsapp', '$twitter', '$site', '$nb_ress', '$duree', '$nb_pdn', '$nb_part', '$nb_pers', '$commentaires')"; }
...
else { $query = "CALL act_Create ('$dat', '$type', '$organise', '$intitule', '$uuid', '$lieu', '$ville', '$pj', '$support', '$facebook', '$whatsapp', '$twitter', '$site', '$nb_ress', '$duree', '$nb_pdn', '$nb_part', '$nb_pers', '$commentaires')"; }

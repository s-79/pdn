        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarsExampleDefault">
            <ul class="navbar-nav nav-pills mb-2 mb-md-0">
                <li class="nav-item mx-1">
                    <a id="menu_pdn" class="nav-link px-4" style="font-size:0.9em;" href="pdn.php"><i class="fas fa-child fa-lg pe-2"></i>PROMENEURS</a>
                </li>
                <li class="nav-item mx-1">
                ...
                <li class="nav-item dropdown">
                    <a id="menu_ress" class="nav-link px-4" style="font-size:0.9em;" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <li class="nav-item mx-1">
                    <a id="menu_part" class="nav-link px-4" style="font-size:0.9em;" href="part.php"><i class="fas fa-handshake fa-lg pe-2"></i>PARTENAIRES</a>
                </li>
                <li class="nav-item mx-1">
                    <a id="menu_act" class="nav-link px-4" style="font-size:0.9em;" href="act.php"><i class="fas fa-users fa-lg pe-2"></i>ACTIONS</a>
                </li>
                <li class="nav-item mx-1">
                    <a id="menu_stat" class="nav-link px-4" style="font-size:0.9em;" href="stat.php"><i class="fas fa-chart-bar fa-lg pe-2"></i>STATS</a>
                </li>

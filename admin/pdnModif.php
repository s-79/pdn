...
<section class=" container mt-4">
    ...
    <div class="mx-auto col-lg-6 pt-3 mt-5 mb-3 blue-bg">
        <h3 class ="orange bg-white text-center pt-2 pb-2">Modifier ou supprimer un PDN</h3></br>
        <div id="recherchePdn">
            <div>
                <label for="zoneTexte" class="d-block mx-auto control-label col-lg-8">Séléctionnez ou saisissez un nom de PDN :</label>
            ...
            <div class="row">
                <button type="button" id="modifPdn" class="d-block mx-auto btn btn-warning mb-4" data-toggle="modal" data-target="#modalModifPdn">Modifier les infos</button>
                ...
                <button type="button" id="suppPdn" class="d-block mx-auto btn btn-danger mb-4" data-toggle="modal" data-target="#modalSuppPdn">Supprimer de la BDD</button>
...
<script src="js/pdnModif.js"></script>

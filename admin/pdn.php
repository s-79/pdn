                ...
                <div class="col-12 col-lg-6 col-xl-4">
                    <div class="bg_bleu m-3 py-2 px-3 rounded rounded-3 div_bleu">
                        <div class="d-flex pt-3">
                            <h1>Coordonnées</h1>
                            <i id="new_pdn" class="ps-3 fas fa-plus-circle fa-2x text-white pointeur" data-toggle="tooltip" data-placement="top" title="Ajouter un·e promeneur·e"></i>
                        </div>
                        ...
                        <form id="form2" action="php/file.php" method="post" enctype="multipart/form-data">
                            <div class="row m-3">
                ...
                <div class="col-12 col-lg-6 col-xl-4">
                    <div class="bg_bleu m-3 py-2 px-3 rounded rounded-3 div_bleu">
                        ...
                        <div class="row mt-3 pt-1 me-1">
                            ...
                            <div class="pt-2 col-2 px-1">
                                <button type="button" id="pwd_create" class="btn btn-warning mx-3 mb-3 pb-2">Créer</button>
                            </div>
                        </div>
                        ...
                        <div id="btn_pdn_create" class="form-group d-flex justify-content-center mx-3">
                            <button type="button" id="pdn_create" class="btn btn-warning mx-3 mb-3 px-3 pb-2">Enregistrer<br>la fiche</button>
                        </div>
                        <div id="btn_pdn_update" class="form-group d-flex justify-content-center mx-3 d-none">
                            <button type="button" id="pdn_update" class="btn btn-warning mx-3 mb-3 px-4">Modifier<br>la fiche</button>
                            <button type="button" id="pdn_delete" class="btn btn-danger mx-3 mb-3">Supprimer <br>la fiche</button>
                        </div>
                    </div>
                </div>
            </div>

...
<section class=" container mt-4">
    ...
    <div class="mx-auto col-xl-7 pt-3 mt-5 mb-3 blue-bg">
        <h3 class ="orange bg-white text-center pt-2 pb-2">Ajouter une ressource</h3><br>
        ...
        <form id="form1">
            ...
            <div class="form-group">
              ...
              <label class="control-label col-7 pl-0">Ajouter une 2ème thématique &nbsp;&nbsp;<i id="plus2" class="fas fa-plus-circle"></i></label>
            </div>
            <div id="divThem2" class="d-none">
                ...
                <div class="form-group">
                  <label class="control-label col-4"></label>
                  <label class="control-label col-7 pl-0">Ajouter une 3ème thématique &nbsp;&nbsp;<i id="plus3" class="fas fa-plus-circle"></i></label>
                </div>
            </div>
            <div id="divThem3" class="d-none">
                ...
                <div class="form-group">
                  <label class="control-label col-4"></label>
                  <label class="control-label col-7 pl-0">Ajouter une 4ème thématique &nbsp;&nbsp;<i id="plus4" class="fas fa-plus-circle"></i></label>
                </div>
            </div>
            <div id="divThem4" class="d-none">
                ...
                <div class="form-group">
                  <label class="control-label col-4"></label>
                  <label class="control-label col-7 pl-0">Ajouter une 5ème thématique &nbsp;&nbsp;<i id="plus5" class="fas fa-plus-circle"></i></label>
                </div>
            </div>
...
<script src="js/outAjout.js"></script>
